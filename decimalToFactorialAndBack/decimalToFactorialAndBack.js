...
var dec2FactString = (nb,arr,i) => {
	...
	result = nb / i
	arr.push(Math.floor(nb % i))
	return dec2FactString(result,arr,i++)
} 

var factString2Dec = (str) => {
	var result = 0;
	for(var i = 0; i < str.length; i++) {
		result += parseInt(str[i]) * factorial(str.length - 1 - i)
	}
	return result
